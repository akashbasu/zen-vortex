...
namespace ZenVortex.DI
{
    ...
    {
        public static List<FieldInfo> GetUnresolvedDependencies<TType>(object instance)
        {
            return typeof(TType).GetFields(BindingFlags.NonPublic | BindingFlags.Instance).Where(field =>
